...
问题用于确定归一化区间，三个参数冻结后的新组合用于独立检查；oracle 指该离散集合中
的最优收敛候选。
...
|---|---:|---:|---:|---:|
| adaptive | 376.464（366.360--383.453） | 218.189（206.263--231.795） | 598.155（582.727--601.642） | 242 |
| global-reference | 1866.094（1824.018--1879.360） | 7182.778（7112.743--7369.940） | 9109.783（8978.837--9249.300） | 3227 |
