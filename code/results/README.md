...
四份 TXT 均由 5.6.0 最终源码以完整模式、4 线程生成。正式两网格相对残量容差为
`1e-6`，循环上限为 20000。
...
| `experiment4_submission_robustness.txt` | 五 seed、六 RHS、中心问题五次计时 | seed 循环和 327/278/866；RHS 循环和 469/336/1507；fast 中心 total 中位数 671.819 ms |
