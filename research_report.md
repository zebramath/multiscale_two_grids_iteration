...
3. 如何随网格分辨率选择有限路径点，并在少 RHS 与多 RHS 场景间平衡 setup 和求解成本。
...
|---|---:|---:|---:|
| 32/8, $10^4$, cross | 11 / 40 / 8.11% | 4 / 37 / 0.00% | 4 / 37 |
| 64/8, $10^4$, cross | 21 / 251 / 104.07% | 8 / 123 / 0.00% | 8 / 123 |
| 64/16, $10^4$, cross | 21 / 65 / 20.37% | 16 / 60 / 11.11% | 18 / 54 |
| 128/16, $10^4$, cross | 43 / 242 / 4.76% | 43 / 242 / 4.76% | 38 / 231 |
| 128/16, $10^2$, cross | 43 / 387 / 71.24% | 32 / 293 / 29.65% | 26 / 226 |
| 128/16, $10^6$, cross | 64 / 273 / 3.80% | 64 / 273 / 3.80% | 62 / 263 |
| 128/16, $10^4$, ring | 43 / 237 / 3.95% | 43 / 237 / 3.95% | 52 / 228 |
...
|---|---:|---:|---:|---:|
| adaptive-fast | 441.810（439.674--456.060） | 260.734（256.842--267.170） | 698.652（652.783--700.408） | 242 |
| adaptive-reuse | 1117.308（1071.153--1379.906） | 243.888（223.884--390.959） | 1361.197（1295.037--1770.866） | 242 |
| global-reference | 2044.307（1823.864--2271.630） | 7256.835（6754.812--9286.458） | 10173.109（8353.519--11558.088） | 3227 |
...
6. 尺度归一化的 fast/reuse 策略把有限路径机制转化为可复现算法。
