...
四份 TXT 均由 5.10.0 最终源码以完整模式、4 线程生成。相对残量容差为 `1e-6`；
...
| `experiment4_submission_robustness.txt` | 五 seed、六 RHS、中心问题五次计时 | seed 循环和 327/866；RHS 循环和 469/1507；adaptive/reference 中心 total 中位数 598.639/9156.505 ms |
