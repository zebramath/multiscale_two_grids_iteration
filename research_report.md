...
中心问题的插值端点对照；Exp3--5 检验选择质量、稳健性、代价和停止策略；Exp6 考察
...
|---|---:|---:|---:|---:|
| adaptive | $495.928\pm33.231$ | $356.869\pm226.063$ | $852.797\pm237.914$ | 242 / 0.944407 |
| global-reference | $2596.774\pm292.274$ | $8849.906\pm1471.671$ | $11446.680\pm1430.207$ | 3227 / 0.995727 |

在该环境中，global-reference 的平均总时间是 adaptive 的 13.42 倍。时间结果用于同机
...
v8.3 的数值证据支持一个集中结论：在当前高对比通道问题、固定粗点和指定磨光器下，
