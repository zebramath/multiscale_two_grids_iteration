# multiscale_two_grids_iteration v7.5
...
- 重主导奇异值下的一阶有利方向、局部 Pareto 律和有限路径反单调条件；
- 能量误差到两网格性能的稳定界与递归 V-cycle 误差分解；
- 七组数值试验，覆盖尺度、对比度、通道拓扑、seed、RHS、重复计时、停止策略消融、
  固定物理场加密和三层 V-cycle。
...
| 文件或目录 | 内容 |
|---|---|
| `research_report.md` | 研究定位、理论概要、实验设计、完整结果和结论 |
| `theory.tex` | 定理、命题、证明、假设和参考文献 |
| `code/` | C++17 实现、七个实验入口和运行脚本 |
| `code/results/` | v7.5 完整复跑结果 |
| `VALIDATION_v7.5.md` | 源码精简、构建、文稿和完整运行验证记录 |
