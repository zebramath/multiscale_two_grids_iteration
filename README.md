# multiscale_two_grids_iteration v8.3
...
- 四个数值主题、八个独立实验，覆盖两网格主结果、几何插值与能量极小插值的中心问题
  对照、两类拓扑的完整路径扫描、自适应规则评估、固定物理场加密和三层 V-cycle pilot。
...
| `code/results/` | v8.1 完整重算结果与 v8.3 新增中心问题对照 |
| `VALIDATION_v8.3.md` | 源码、实验、文稿和文件完整性验证记录 |
