...
四份 TXT 均由 4.8.0 最终源码以完整模式、4 线程生成。正式两网格相对残量容差为
`1e-6`，循环上限为 20000。
...
| `experiment3_oracle_validation.txt` | 七问题 step--2 离线 oracle | fast 平均/最大 gap 30.90%/104.07%，reuse 为 7.61%/29.65% |
| `experiment4_submission_robustness.txt` | 五 seed、六 RHS、中心问题五次计时 | seed 循环和 327/278/866；RHS 循环和 469/336/1507；fast 中心 total 中位数 698.652 ms |
