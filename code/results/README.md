...
实验 7 由 v6.4.0 源码以完整模式、4 线程新增运行；实验 1--6 未重复运行或改写。
...
| `experiment7_multilevel_pilot.txt` | 64/16/8、128/16/8 三层 V-cycle 与首层精确两网格配对 | adaptive V-cycle 为 101/237 次，reference 为 321/770 次；二者均 2/2 收敛 |
