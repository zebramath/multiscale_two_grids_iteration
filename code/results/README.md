...
四份 TXT 均由 4.4.0 最终源码以完整模式、4 线程生成。

| 文件 | 覆盖范围 | 核心结果 |
|---|---|---|
| `experiment1_two_grid_comparison.txt` | 11 个尺寸/对比度/拓扑问题 | fast 2850 次、reuse 2382 次、reference 11074 次；fast 相对 reuse 降低 80.0% setup |
